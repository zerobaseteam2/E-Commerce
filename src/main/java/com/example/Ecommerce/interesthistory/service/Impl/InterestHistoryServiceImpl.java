...
public class InterestHistoryServiceImpl implements InterestHistoryService {
    ...
    public InterestHistoryCreateDto.Response addInterest(Long userId, Long productId) throws Exception {
        ...
        InterestHistory interestHistory = InterestHistoryCreateDto.Request.toEntity(
                new InterestHistoryCreateDto.Request(userId, productId), user, product);
    ...
    @Override
    public Page<InterestHistoryResponseDto> getInterestHistories(Long userId, int page, int size) throws Exception {
        Pageable pageable = PageRequest.of(page, size);

        // Replace the repository method call with the custom implementation
